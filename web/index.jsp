                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <!-- User Image -->
                                                <img src="AdminLTE-master/dist/img/user2-160x160.jpg" class="img-circle"
                                                     alt="User Image">
                                            </div>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-body">
                                <div class="row">
                                    ...
                                    <%--                                    </div>--%>
                                    <div class="col-xs-4 text-center">
                                        <a data-id="friends" class="button" href="#">Friends</a>
                                    </div>
                                </div>
                                <!-- /.row -->
                            </li>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li data-id="pages" class="button"><a href="#"><i class="fa fa-link button"></i> <span>Pages</span></a>
                </li>
                <li data-id="functions" class="button"><a href="#"><i class="fa fa-link"></i> <span>Functions</span></a>
                </li>
                <li class="treeview">
